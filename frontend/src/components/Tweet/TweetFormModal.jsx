...
export const TweetFormModal = ({
    ...
    const isDirty = content.trim().length > 0 || !!media;
    ...
    return (
        ...
        >
            ...
            <Box
                ...
                alignItems="center"
                position="relative"
                sx={{ borderTop: "1px solid #e6ecf0", pt: 1, mt: 1 }}
            >
